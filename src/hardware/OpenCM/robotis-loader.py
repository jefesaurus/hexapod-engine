...
# If this part fails and you are running ubuntu or similar
# try uninstalling "modemmanager". It apparently slows down the device for ~30 secs
# so it isn't able to reconect after resetting it(unless you time.sleep(30))
print('* Connecting...')
s = serial.Serial(port, baudrate=115200)
s.write('AT&LD')
